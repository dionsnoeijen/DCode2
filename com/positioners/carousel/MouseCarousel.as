package com.positioners.carousel
{
	 ...
	 * @author Devon O.
	 */
	public class MouseCarousel extends Sprite 
	{	
		...
		public function MouseCarousel(focalLength:int = 800, radius:int = 300, zpos:Number = 0):void 
		{
			_fl = focalLength;
			_radius = radius;
			_zpos = zpos;
