/* ------------------------------------------
/* AppleStyle Preloader
/*
/* Author: Dion Snoeijen
/* Date: 27-04-2010
/*
/* Create Apple Style Preloader
/*
/* ------------------------------------------ */

package com.graphics.preloaders
{
    ...
    public class AppleStyle extends Sprite
    {
        private var timer:Timer;
        private var slices:int;
        private var radius:int;

        public function AppleStyle(slices:int = 12, radius:int = 6)
        {
            //super();
            this.slices = slices;
            this.radius = radius;
